...
def renderLoginPage():
    ...
    if request.method == 'POST':
        ...
        if len(Age) != 2:
            return render_template('loginfail.html',errors = ["Invalid Age!"])
        ...
        runQuery("INSERT INTO participants(event_id,fullname,email,mobile,age,college,branch_id) VALUES({},\"{}\",\"{}\",\"{}\",\"{}\",\"COEP\",\"{}\");".format(Event,Name,Email,Mobile,Age,Branch_id))
...
def renderParticipants():
    ...
    if request.method == "POST":
        ...
        participants = runQuery("SELECT p_id,fullname,mobile,email,age FROM participants WHERE event_id={}".format(Event))
